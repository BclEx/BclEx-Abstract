...
namespace Contoso.GenericBusHost
{
    internal partial class Host : ServiceBase
    {
        ...
        protected override void OnStart(string[] ignored)
        {
            ...
            catch (Exception x) { Log.Fatal("Hosted service failed to start", x); throw; }
        }

        private Assembly LoadAssembly()
        {
            try { return Assembly.LoadFrom(asm); }
            catch (FileNotFoundException) { throw new InvalidOperationException("The specified assembly file was not found: " + asm); }
        }
        ...
        protected override void OnStop()
        {
            ...
            catch (Exception x) { Log.Fatal("Hosted service failed to stop", x); throw; }
        }
